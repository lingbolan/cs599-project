...
.\.venv\Scripts\autospider.exe chat-pipeline --target-url-count 5 --max-pages 1 -r "Collect 5 anime entries from Bangumi calendar page https://bangumi.tv/calendar. Fields: Chinese title, Japanese title, weekday. Target URL count 5."
